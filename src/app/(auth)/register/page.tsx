    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="relative my-4">
          ...
          <div className="relative text-center text-xs text-gray-400 bg-white px-2 w-fit mx-auto">{t("or")}</div>
        </div>

        <button onClick={handleGoogle} className="w-full py-2.5 border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium rounded-lg text-sm transition-colors flex items-center justify-center gap-2">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <Link href="/login" className="text-indigo-600 font-medium hover:underline">{t("signIn")}</Link>
        </p>
      </div>
    </div>
  );
